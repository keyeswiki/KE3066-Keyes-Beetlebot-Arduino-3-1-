...
- 用\ **KidsBlock**\ 打开\ **180_Servo_Angle_initialization.sb3**\ ，并上传至NANO开发板。
...
8*8点阵屏通过LED(发光二极管）组成，以灯珠亮灭来显示文字、图片、动画、视频等，8\ *8
...
|image137|\ HIGH相当于PWM值255，50是PWM值，是可以调整的。此代码中的差值是200，上下差值越大，电机转速越快，我们可以通过调整PWM值达到调节电机转速。如果将50调为0，上下差值就变成255，电机转速达到最大；如果将50调为255时，上下差值就变成0，电机转速为0，电机就不转动了。上下差值为正值时，电机反转。

|image138|\ LOW相当于PWM值0，200是PWM值，是可以调整的。此代码中的差值是200，上下差值越大，电机转速越快，我们可以通过调整PWM值达到调节电机转速。如果将200调为100，上下差值就变成100，电机转速减慢；如果将200调为255时，上下差值就变成255，电机转速达到最大；如果将200调为0时，上下差值变为0，电机就不转动了。上下差值为负值时，电机正转。
...
点击\ |image-20230703102539467|\ 进入主控板页面，可以选择需要添加的设备（控制板），本项目需要选择ESP8266主控板。先点击ESP8266主控板所处区域，后点击“\ **\*连接\***\ ”。这样ESP8266主板已连接上，点击“\ **\*返回编辑器\***\ ”回到代码编辑器。这样，我们会发现\ |image-20230703103305405|\ 变成\ |image-20230703103216430|\ ，同时\ |image-20230703103236895|\ 变成\ |image174|\ ，说明ESP8266主板和端口（COM)
都已经连接上了。
...
模块，先点击\ |image179|\ 图标进入传感器/模块扩展界面，然后找到并点击
“Beetlebot wifi” 区域 ，“未加载”会变成“已加载”。这样，Beetlebot wifi
模块就添加成功，点击\ |image180|\ 返回代码编辑器界面，就可以看到添加的Beetlebot
wifi 模块。

|image-20230703132125286| |image181|\ |image-20230703131901487|
|image182|\ |image-20230703131929026|
|image183|\ |image-20230703132002666|
...
点击串口监视器窗口中的\ |image190|\ ，将波特率设置为9600。这样，串口监视器就显示此时你们WIFI的IP地址。（\ **WIFI的IP地址有时候会改变，如果原来的IP地址不行，需要重新检测WIFI的IP地址**)
...
点击\ |image206|\ 按钮，小车前面的8\ *8点阵显示“笑脸”图案；点击\ img\ 按钮，小车前面的8*\ 8点阵显示“十”图案；点击\ |image207|\ 按钮，小车前面的8*8点阵显示“❤”图案。
...
.. |image60| image:: img/31a422dcb037155d8fef5a825d82911a.png
.. |image61| image:: img/1d9213ccae6705c195237af3ffb1cbdf.png
.. |image62| image:: img/41231d19a1203765f04fdc2da973d6d3.png
.. |image63| image:: img/7f7365967c1556604179415a67b03f7b.png
.. |image64| image:: ./img/28f3235b60a49be9cb20087d9542d390.png
.. |image65| image:: ./img/17905dc94b39de00e0d3c872363f3bb1.png
.. |image66| image:: ./img/bff846d943f6d7ba6168856233bb37f6.png
.. |image67| image:: ./img/096c2b8f73b4b12982a065d37c7ff848.png
.. |image68| image:: ./img/2e0f4e1c611dd272a7f5b99ed66e8c6d.png
.. |image69| image:: ./img/4ff5fd5171d1de67eb694e90464a3c2a.png
.. |image70| image:: ./img/0c6f8953cd1687bd71e0d9b5aed459fc.png
.. |image71| image:: ./img/5ecac913601bd56d8fdaff2a318cb610.png
.. |image72| image:: ./img/a7ee2b56f0b22a8933c26e1b13021ea5.png
.. |image73| image:: ./img/867d6e1de673fdb4e5a06c8017e3b270.png
.. |image74| image:: ./img/f9a1bd4b7cdbcdb902f0279be65ad004.png
